...
public class CancelVPOPCSRPendingTest extends BaseTest {
    @Test(priority = 22)
    public void testCancelVPOPCSRPending() throws IOException, InterruptedException {
        logger = extent.startTest("Test Cancel VPOP CSR Pending");
