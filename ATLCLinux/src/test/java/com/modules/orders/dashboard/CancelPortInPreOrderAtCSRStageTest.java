...
public class CancelPortInPreOrderAtCSRStageTest extends BaseTest {
    @Test(priority = 12)
    public void testCancelPortInPreOrderAtCSRStage() throws IOException, InterruptedException {
        logger = extent.startTest("Test Cancel Port-in PreOrder(CSR Stage)");
