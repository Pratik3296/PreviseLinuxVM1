...
public class RejectPortInPreOrderAtLSRStageTest extends BaseTest {
    @Test(priority = 8)
    public void testRejectPortInPreOrderAtLSRStage() throws IOException, InterruptedException {
        ...
        if(portInPage.errorMessage()==null){
            ...
            portInPage.verifyPortTypeAndStatus("LSR Rejected","port-in" );}
        else{
