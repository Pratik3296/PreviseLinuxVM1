...
public class PortInPreOrderAndOrderWithOutCSRTest extends BaseTest {
    @Test(priority = 6)
    public void testPortInPreOrderAndOrderWithOutCSR() throws IOException, InterruptedException {
        logger = extent.startTest("Test PortIn PreOrder And Order WithOut CSR");
